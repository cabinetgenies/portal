...
export const specialistResultSchema = z.object({
  ...
  recommended_actions: z.array(proposedActionSchema).max(10).optional(),
  actions_taken: z.array(z.string().min(1)).max(20).optional(),
  actions_requested: z.array(dependencyRequestSchema).max(5).optional(),
  requires_approval: z.boolean().optional(),
  escalation: z.string().min(1).nullable().optional(),
  sources: z.array(sourceReferenceSchema).max(20).optional(),
